...
describe('day5 tests', () => {
    describe('using spies', () => {
        ...
        it('should make a request once', (done) => {
        ...
        it('should make request with expected URL', (done) => {
            day5('expressjs', 'express', (data) => {
                expect(spyRequestGet.getCall(0).args[0].uri).to.equal('https://api.github.com/repos/expressjs/express');
                done();
            })
        })
    })
    ...
    describe('using stubs', () => {
        ...
        // Should return correct data when API call succeeds
        ...
        // Should return correct data when rate limited
        it('should return expected data when rate limited', (done) => {
            ...
            day5('expressjs', 'express', (data) => {
                expect(data).to.deep.equal({
                    success: false,
                    statusCode: 403,
                    error: 'API is rate limited - please try again later'
                });
                done();
            })
        })
